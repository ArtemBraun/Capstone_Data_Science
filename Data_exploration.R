...
fileName <- "./en_US/en_US.blogs.txt"
...
Mb_in_Blogs <- file.info("./en_US/en_US.blogs.txt")$size/1024/1024
close(con)

fileName <- "./en_US/en_US.news.txt"
...
Mb_in_News <- file.info("./en_US/en_US.news.txt")$size/1024/1024
close(con)

fileName <- "./en_US/en_US.twitter.txt"
con <- file(fileName,open="r")
...
Mb_in_Twitter <- file.info("./en_US/en_US.twitter.txt")$size/1024/1024
close(con)
